  ...
  heads: [
    {
      ...
      title: 'Large Cyclops',
      src: '/api/assets/head-big-eye.png',
      type: 'heads',
      cost: 1225.5,
    },
    {
      ...
      title: 'Friendly',
      src: '/api/assets/head-friendly.png',
      cost: 945.0,
      type: 'heads',
      onSale: true,
    },
    {
      ...
      title: 'Shredder',
      src: '/api/assets/head-shredder.png',
      type: 'heads',
      cost: 1275.5,
    },
    {
      ...
      title: 'Small Cyclops',
      src: '/api/assets/head-single-eye.png',
      type: 'heads',
      cost: 750.0,
    },
    {
      ...
      title: 'Surveillance',
      src: '/api/assets/head-surveillance.png',
      type: 'heads',
      cost: 1255.5,
    },
  ],
  arms: [
    {
      ...
      title: 'Articulated',
      src: '/api/assets/arm-articulated-claw.png',
      type: 'arms',
      cost: 275,
    },
    {
      ...
      title: 'Two Clawed',
      src: '/api/assets/arm-dual-claw.png',
      type: 'arms',
      cost: 285,
    },
    {
      ...
      title: 'Grabber',
      src: '/api/assets/arm-grabber.png',
      type: 'arms',
      cost: 205.5,
    },
    {
      ...
      title: 'Propeller',
      src: '/api/assets/arm-propeller.png',
      type: 'arms',
      cost: 230,
      onSale: true,
    },
    {
      ...
      title: 'Stubby Claw',
      src: '/api/assets/arm-stubby-claw.png',
      type: 'arms',
      cost: 125,
    },
  ],
  torsos: [
    {
      ...
      src: '/api/assets/torso-flexible-gauged.png',
      type: 'torsos',
      cost: 1575,
    },
    {
      ...
      title: 'Gauged',
      src: '/api/assets/torso-gauged.png',
      type: 'torsos',
      cost: 1385,
    },
    {
      ...
      title: 'Gauged',
      src: '/api/assets/torso-pouch.png',
      type: 'torsos',
      cost: 785,
      onSale: true,
    },
  ...
  bases: [
    {
      ...
      src: '/api/assets/base-double-wheel.png',
      type: 'bases',
      cost: 895,
    },
    {
      ...
      title: 'Rocket',
      src: '/api/assets/base-rocket.png',
      type: 'bases',
      cost: 1520.5,
    },
    {
      ...
      src: '/api/assets/base-single-wheel.png',
      type: 'bases',
      cost: 1190.5,
    },
    {
      ...
      title: 'Spring',
      src: '/api/assets/base-spring.png',
      type: 'bases',
      cost: 1190.5,
    },
    {
      ...
      src: '/api/assets/base-triple-wheel.png',
      type: 'bases',
      cost: 700.5,
    },
  ],
